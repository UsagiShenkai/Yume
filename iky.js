...
fakelink = (tekslink) => { 
	return {"externalAdReply": { "title": tekslink, "thumbnail": ikyads, "sourceUrl": "https://wa.me/6285717026352" }}
}
// AFK
	if (isGroup) {
...
if (args.length < 2) return reply(`Penggunaan ${command} idgroup`)
        ...
        case 'creator':
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: ' ```BOT CREATED BY YUME``` ',
               buttons: buttons,
               headerType: 1
}
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6285717026352`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
*࿊⃟🌸𝐆𝐈𝐓𝐇𝐔𝐁* :
*https://github.com/UsagiShenkai*
*࿊⃟🌸𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌* :
*https://instagram.com/ganna_amv*      
*࿊⃟🌸𝐓𝐈𝐊𝐓𝐎𝐊* :
*https://tiktok.com/@yume9923*
*࿊⃟🌸𝐘𝐎𝐔𝐓𝐔𝐁𝐄* :
*https://youtube.com/channel/UChnO1SAX57GrUkLOr-XKecA*

     *𝐓𝐄𝐑𝐌𝐒 𝐎𝐅 𝐒𝐄𝐑𝐕𝐈𝐂𝐄*

YUME BOT merupakan project bot WhatsApp yang menggunakan Vps Atau Rdp, dijalankan menggunakan engine nodejs v14.0.0
...
case 'lock':
 ikymemek = {
  "key": {
    "fromMe": false,
    participant: `6285717026352@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
*࿊⃟📚結* ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created ʏᴜᴍᴇ-ʙᴏᴛ🌠`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
        ...
        case 'wasted':
					...
					break
					case 'tahta':
					buff = await getBuffer(`https://leyscoders-api.herokuapp.com/api/harta-tahta?@=${q}&apikey=IkyOgiwara`)
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @ganna_amv`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ʏᴜᴍᴇ-ʙᴏᴛ🌠', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @ganna_amv`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ʏᴜᴍᴇ-ʙᴏᴛ🌠T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @ganna_amv`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
`
 ...
 ʏᴜᴍᴇ-ʙᴏᴛ🌠︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
`
 ...
 ʏᴜᴍᴇ-ʙᴏᴛ🌠︎`, imageMessage: imageMsg,
   ...
   case 'command':
               ...
               const yy = {title: 'Yume Menu' + nombor++,
                    rows: [
                       {
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated ʏᴜᴍᴇ-ʙᴏᴛ🌠︎`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*『 ʏᴜᴍᴇ-ʙᴏᴛ🌠︎ 』*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Thank you for late registration ʏᴜᴍᴇ-ʙᴏᴛ🌠*`)
		}, 2000)
        break
case 'tos':
...
YUME BOT merupakan project bot WhatsApp yang menggunakan termux, dijalankan menggunakan engine nodejs v14.0.0
...
Owner: Pacar Yume<3 | wa.me/6285717026352`
...
┃💌 : wa.me/6285717026352
┃💌 : ==============
┃💌 : Instagram : _*@ganna_amv*_
┃💌 : YouTube : _*Saguchi Ofc*_
┗━━⬣
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `𝐏𝐑𝐄𝐌𝐈𝐔𝐌`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ʏᴜᴍᴇ-ʙᴏᴛ🌠︎ ', imageMessage: imageMsg,
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `𝐎𝐖𝐍𝐄𝐑👑`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:' ```BOT CREATED BY YUME``` ', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
              break
...
├ *NAME*  : Shenkai 
├ *VERSION* : 1.0
├ *GITHUB* : https://github.com/UsagiShenkai
│
├─『 *𝙏𝙃𝘼𝙉𝙆𝙎 𝙏𝙊* 』
│
├ ALLAH SWT
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('6285717026352@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('6285717026352@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              ikyy.sendMessage('6285717026352@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
